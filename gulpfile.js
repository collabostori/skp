...
// build korean file list to json data
gulp.task('seperate:build:kor:fileListJson', function() {
  fileData('./html/kor/', './data/file_list_kor.json');
});
// build english file list to json data
gulp.task('seperate:build:eng:fileListJson', function() {
  fileData('./html/eng/', './data/file_list_eng.json');
});
// build error file list to json data
gulp.task('seperate:build:err:fileListJson', function() {
  fileData('./html/err/', './data/file_list_err.json');
});
